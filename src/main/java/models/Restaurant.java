...
public class Restaurant {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && name.equals(that.name) && address.equals(that.address) && zipcode.equals(that.zipcode) && phone.equals(that.phone) && website.equals(that.website) && email.equals(that.email);
    }
